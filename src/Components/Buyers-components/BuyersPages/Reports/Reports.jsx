...
// const Reports = () => {
//   return (
//     <div>Reports for Buyers comes here</div>
//   )
// }
...
const Reports = () => {
  ...
  return (
    <div style={styles.app}>
      <h1 style={styles.h1}>My Order History -- {buyerName} </h1>
      <table style={styles.table}>
        <thead>
          <tr>
            <th style={{ ...styles.thTd, ...styles.th }}>S/N</th>
            <th style={{ ...styles.thTd, ...styles.th }}>Order Date</th>
            <th style={{ ...styles.thTd, ...styles.th }}>Farmer Name</th>
        ...
        <tbody>
          {sortedOrders.map((order, index) => (
            <tr key={index}>
              ...
              <td style={styles.thTd}>{order.farmer_name}</td>
